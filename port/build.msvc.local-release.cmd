...
echo -^> local-release quantum-script-extension-openssl
...
call :cmdX xyo-cc quantum-script-extension-openssl --archive-release-sha512 --version-file=source/quantum-script-extension-openssl.version.ini
