...
call :cmdX xyo-cc --mode=%ACTION% @build/source/quantum-script-extension-openssl.static.compile
call :cmdX xyo-cc --mode=%ACTION% @build/source/quantum-script-extension-openssl.dynamic.compile
