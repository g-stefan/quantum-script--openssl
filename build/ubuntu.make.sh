...
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-openssl.static.compile.unix
cmdX xyo-cc --mode=$ACTION @build/source/quantum-script-extension-openssl.dynamic.compile
