...
#	define XYO_QUANTUMSCRIPT_EXTENSION_OPENSSL_EXPORT XYO_PLATFORM_LIBRARY_EXPORT
#else
#	define XYO_QUANTUMSCRIPT_EXTENSION_OPENSSL_EXPORT XYO_PLATFORM_LIBRARY_IMPORT
#endif
